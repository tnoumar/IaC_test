...
name = "csestoragelogo" #add your name to make it unique. Can only 
consist of lowercase letters and numbers, and must be between 3 and 24 
characters long.
...
name = "container-logo"
6_2025 – Deployment Guide Portal – EN2025 - CSE Guides - EN - V4.docx 2025 | © Wavestone | 30
...
name = "csestoragelogs" # #add your name to make it unique. Can only 
consist of lowercase letters and numbers, and must be between 3 and 24 
characters long.
resource_group_name = var.rg_name
location = var.location
...
# Allows public access to blobs/containers
allow_nested_items_to_be_public = true
6_2025 – Deployment Guide Portal – EN2025 - CSE Guides - EN - V4.docx 2025 | © Wavestone | 31
Internal distribution
} 
# Create a Blob inside the Storage Account
