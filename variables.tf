...
# You can find it in the Azure portal under "Subscriptions" > "Subscription 
ID".
...
variable "rg_name" { 
    type = string
    default = "sandbox_taha.noumar"
} 
6_2025 – Deployment Guide Portal – EN2025 - CSE Guides - EN - V4.docx 2025 | © Wavestone | 28
Internal distribution
# Define a variable for the Azure region (location) where resources will be 
deployed.
variable "location" { 
    type = string
